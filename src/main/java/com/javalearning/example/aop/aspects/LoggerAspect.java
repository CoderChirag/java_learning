package com.javalearning.example.aop.aspects;
...
public class LoggerAspect {
  ...
  @Around("execution(* com.javalearning.example.aop.services.*.*(..))")
  ...
  @Around("@annotation(com.javalearning.example.aop.interfaces.LogAspect)")
  ...
  @AfterThrowing(value = "execution(* com.javalearning.example.aop.services.*.*(..))", throwing = "ex")
  ...
  @AfterReturning(value = "execution(* com.javalearning.example.aop.services.*.*(..))", returning = "retVal")
